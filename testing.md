...
In this stage of the project, I have completed my entire code and have a running and working game. The game is running as expected and there are no huge errors preventing my game from happening. I have fixed the wall problem in the sense that the wall does not print every time the player wants to move the character, it just prints once and then stays on the screen until the player loses. I have fixed the issue of the player moving down on the grid in the terminal and now the player moves the character up. I have also made the game a bit more competitive in the sense that the player actually has to strategically use their rests to get to the top and not run out of energy too quickly. An overall description of the game is that the character begins in the bottom left hand of the terminal and moves around the board depending on how the player strategically maneuvers the character. Just like climbing a mountain, there are good holds and bad holds but you are not too sure of which ones are good and bad. It is revealed after you have grabbed it. By grabbing a bad hold, the character's energy goes down just like in the real world. By grabbing a good hold (rest) the character regains more energy so that it is easier to get up the mountain. Once you finish the pitch, you move on to the next pitch and continue through the harder sections until you run out of energy and fall.
