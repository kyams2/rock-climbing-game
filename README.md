...
2) Functions Used:
a) While Loop Function (while running:) - This function will be used to keep the code running.
b) For Loop Function (ex. for i in range(1 , 5):) - This function will allow me to load all of the animated images that I want to use for my simulation/game at once. I can also use a for loop to put all of the holds in their particular spot in the simulation/game.
c) 
